    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_by", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="created_ics205b_forms", to=settings.AUTH_USER_MODEL)),
                ("incident", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="ics205b_forms", to="incidents.incident")),
                ("operational_period", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="ics205b_forms", to="incidents.operationalperiod")),
            ],
            options={"ordering": ["incident", "operational_period__starts_at", "created_at"]},
        ),
        migrations.AddConstraint(
            model_name="ics205bform",
            constraint=models.UniqueConstraint(fields=("incident", "operational_period"), name="unique_ics205b_incident_period"),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("form", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="assignments", to="extensions.ics205bform")),
            ],
            options={"ordering": ["position", "created_at"]},
        ),
        migrations.AddConstraint(
            model_name="ics205bassignment",
            constraint=models.UniqueConstraint(fields=("form", "position"), name="unique_ics205b_form_position"),
        ),
    ]
