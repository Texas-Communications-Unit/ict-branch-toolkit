...
| -------------------------------------------- | ---------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------ |
| `frontend/public/brand/tx-comu-logo.svg`     | `brand/assets/logos/originals/TX-COMU.svg`     | Alternate scalable source artwork retained for approved derivative uses | `c5ea041ab01b375b6ce6f83cfb1096d007adfb292310499adac94cb0f82a5bae` |
| `frontend/public/brand/tx-comu-logo.png`     | `brand/assets/logos/tx-comu-logo.png`          | Preferred general-use application identity                              | `5fd6b8afa4654c75525a96cf850efdf49d967bcadd03b41814367ed989c9d778` |
